...
public class Deck {
    ...
    private Card[] cards;
    private int nextCard;// devuelva nueva carta

    //CONSTRUCOR- INICIALIZACION
    public Deck() {
        cards = new Card[48];
        int count = 0;
...
//BARAJAR
    public void shuffle() {
        for (int i = 0; i < cards.length; i++) {
            int aleat = (int) (Math.random() * cards.length); //aleatorio

            //cambia de posicion las carta en el array
            Card temp = cards[i];
            cards[i] = cards[aleat];
            cards[aleat] = temp;
        }
...
//EXTRAER- Q DEVUELVA UNA CARTA. NO PUEDE DEVOLVER LA MISMA CARTRA
    ...
    public String toString() {
        String s = "";// ALMACENAMIENTO

        //DIVIDE EN 4 PALOS Y LAS AGRUPA
    ...
    // QUE DE EL CADA PALO Y LAS SEPARE Y PONGA ,
